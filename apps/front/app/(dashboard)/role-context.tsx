  ...
  GURU: [
    ...
    },
    {
      ...
      items: [
        { label: "Overview CBT", icon: ClipboardCheck, href: "/cbt", note: "Dashboard CBT" },
        { label: "Bank Soal", icon: BookOpen, href: "/bank-soal", note: "Kelola soal" },
        { label: "Kelompok Soal Wacana", icon: BookText, href: "/kelompok-soal", note: "Wacana/naskah referensi" },
        { label: "Paket Soal", icon: Package, href: "/paket-soal", note: "Kelola paket" },
        { label: "Kelola Ujian", icon: Settings, href: "/kelola-ujian", note: "Edit & hapus ujian" },
        { label: "Ujian Akan Datang", icon: CalendarClock, href: "/ujian", note: "Buat & kelola" },
        { label: "Ujian Berlangsung", icon: Activity, href: "/ujian/berlangsung", note: "Monitoring" },
        { label: "Hasil Ujian", icon: BarChart3, href: "/ujian/hasil", note: "Penilaian" },
      ],
    },
  ],
  SISWA: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Hasil Ujian Saya", icon: BarChart3, href: "/hasil-ujian-saya", note: "Lihat nilai" },
      ],
    },
    {
      label: "Akun",
