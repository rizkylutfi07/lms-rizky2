...
const accessByRole: Record<Role, string[]> = {
  ADMIN: ["/", "/profile", "/change-password", "/users", "/siswa", "/kenaikan-kelas", "/guru", "/kelas", "/jurusan", "/tahun-ajaran", "/mata-pelajaran", "/jadwal-pelajaran", "/rpp", "/materi", "/materi-management", "/tugas", "/tugas-management", "/forum", "/attendance", "/absensi-kelas", "/database", "/cbt", "/bank-soal", "/paket-soal", "/jenis-ujian", "/kelola-ujian", "/ujian", "/penilaian", "/laporan", "/keuangan", "/keamanan", "/settings", "/pengumuman"],
  GURU: ["/", "/profile", "/change-password", "/kelas", "/mata-pelajaran", "/jadwal-pelajaran", "/rpp", "/materi", "/materi-management", "/tugas", "/tugas-management", "/forum", "/pengumuman", "/attendance", "/absensi-kelas", "/cbt", "/bank-soal", "/paket-soal", "/ujian", "/penilaian", "/laporan"],
